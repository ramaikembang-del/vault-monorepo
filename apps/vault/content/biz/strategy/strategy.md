...
**Purpose:** The central nervous system of PWBI F&B Growth. This directory defines *why* we exist, *who* we serve, and *how* we win. It connects high-level vision to ground-level execution.

---

## Planning & Core Drivers
**Location:** `/planning/`

The foundational documents defining the business.
...
## Execution & Sprint Strategy
**Location:** `/execution/`

Turning strategy into action.
- **[[biz/strategy/execution/01-business-strategy|Business Strategy]]** - The overall game plan.
- **[[biz/strategy/execution/02-platform-strategy|Platform Strategy]]** - Technical ecosystem vision.
- **[[biz/strategy/execution/03-consolidated-financial-strategy|Financial Strategy]]** - Revenue & growth modeling.
- **[[biz/strategy/planning/execution/03-sprint-1-roadmap|Sprint Master Plans]]** - Specific tactical plans (Phase 1, 2, 3).
...
```
strategy/
|-- execution/ (Business, Platform, & Financial Strategy)
|-- frameworks/ (Decision Making & OKRs)
|-- market-analysis/ (Personas, Competition, Market Size)
|-- planning/ (Roadmaps, Briefs, Prioritization)
```

---

**Last Updated:** 2026-01-04
**Owner:** Founder (CEO Strategy)
