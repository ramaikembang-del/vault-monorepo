...
- **One integrated dashboard** - all data in one place
- **Deep metrics tied to workflow** - not just surface numbers
- **Systematic tracking** - root causes visible daily, not monthly
- **Proactive by default** - alerts and drill-throughs guide action
...
| 14 | Improvement Trend | "↑ 12% vs last week (green) or ↓ 8% (red)" |
...
| 6 | Repeat Rate % | Returners ÷ First Timers |
...
11. Lost Revenue Risk (Lapsed VIP count × avg VIP check)
...
**From Executives:**
- Budget approval for BI developer (22 hours over 5 weeks)
- Data team go-ahead (load CSVs or prepare SQL views)
- Timeline commitment (5-week implementation)
- Project sponsor assignment

**From Developers:**
- Assign BI developer
- Schedule kickoff meeting this week
- Review ready resources (`/src/sql/`, `/data/`, `/assets/themes/`)

**From the AM:**
- 2-hour training commitment (Week 4)
- Daily 5-minute usage commitment
- Brutally honest feedback during testing
...
**For Developers:**
- **Build Guide:** [[products/01-power-bi-template/specifications/core/04-implementation-subset|Implementation Subset]] (~25 metrics/tab)
- **DAX Formulas:** [[products/01-power-bi-template/specifications/technical/02-database-schema|Database Schema]] (copy-paste ready)
- **Visual Layouts:** [[products/01-power-bi-template/specifications/technical/03-design-ux-specifications|Design & UX Specs]] (mockups, colors, interactions)
- **Setup Guide:** [[biz/departments/operations/deployment/01-deployment-guide|DEPLOYMENT.md]] (step-by-step first-time setup)
