...
```
Check these 5 views:
˜‘ vw_PowerBI_Sales_Feed
˜‘ vw_PowerBI_Dim_Staff
˜‘ vw_PowerBI_Fact_Feedback
˜‘ vw_PowerBI_Fact_StaffHours
˜‘ vw_PowerBI_Fact_Bookings
...
- 11 PM: POS exported yesterday's data
- 6 AM: Task Scheduler imported to SQL
- 6:05 AM: SQL Server has latest data
...
## Daily Ecosystem Bundle Support Monitoring (NEW)

**For Tier 1-3 Customers:**

### Morning Checklist Addition (5 minutes)

**Excel Template Support Monitoring:**
- [ ] Check for new Tier 1 customers (Week 1 most critical)
 - Common issue: "Excel won't import to Power BI"
 - Quick fixes:
 1. Date format wrong (must be YYYY-MM-DD)
 2. Blank rows in Excel (delete them)
 3. Column headers don't match template exactly
 - Response time: <24h (prevent early frustration)

- [ ] Tier 2/3 customers requesting template updates
 - New products to add to dropdown: Track in spreadsheet
 - New staff hired/departed: Update Staff-Log dropdown
 - Priority: <48h for Tier 3, <7 days for Tier 2

- [ ] Google Sheets sync issues (rare, but check)
 - Formula errors after Google updates
 - Make-a-copy links broken
 - Mobile dropdown issues

### Weekly Support Trends

**Track common Excel issues:**
| Issue | Frequency | Fix | Updated Guide? |
|-------|-----------|-----|----------------|
| Date format errors | - | YYYY-MM-DD conversion | - |
| Dropdown not working | - | Re-select data validation range | - |
| Import fails | - | Check column headers match | - |

**Action:** If same issue >3 times/week -> Update FAQ or create video tutorial
 ...
 **Total Daily Effort:** 1-2 minutes

 **Monthly Cost:** $0

 **Complexity:** Low (one-time setup, then routine)
