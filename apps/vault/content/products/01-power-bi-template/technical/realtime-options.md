...
**Costs:**
- Power BI Pro: $10/user/month x 3 = $30/month
...
- **[[products/01-power-bi-template/technical/technical|Technical Documentation]]** - Parent directory
- **[[products/01-power-bi-template/specifications/technical/01-power-bi-tech-spec|Power BI Technical Spec]]** - Architecture details
- **[[products/01-power-bi-template/technical/deployment/02-infrastructure-options|Infrastructure Options]]** - Deployment architecture
- **[[products/01-power-bi-template/integrations/01-pos-compatibility|POS Compatibility]]** - Data source integrations
- **[[products/01-power-bi-template/technical/database/01-sql-server-guide|SQL Server Guide]]** - Database setup
