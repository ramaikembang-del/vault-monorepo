...
## Path A: Ecosystem Bundle (Recommended - 30 minutes)

**Best for 90% of users.** Uses Excel templates instead of SQL views.

**What You Get:**
- 4 Excel Templates (Daily-Sales, Food-Cost, Staff-Log, Outlet-Summary)
- Power BI Dashboard (one-click refresh)
- 30-minute setup (vs 3-hour SQL setup)

**Quick Start:**
1. Fill Daily-Sales.xlsx with 3-7 days of sample data
2. Open Power BI Dashboard -> Get Data -> Excel -> Select Daily-Sales.xlsx
3. Create relationships (Date, Staff)
4. Home -> Refresh
5. Done! Dashboard shows your data

**See:** [[products/01-power-bi-template/training/01-quick-start-guide|quick-start-guide.md]] for complete Excel-first workflow

---

## Path B: SQL Server (Advanced - This Guide)

**For:** Large enterprises with 500K+ daily transactions or real-time needs.

This guide explains how to assemble the assets created in this project into a working Power BI Dashboard.

## Implementation Scope

**This deployment implements:** [[products/01-power-bi-template/specifications/core/04-implementation-subset|Implementation Subset]] (~25 metrics/tab for daily AM use)
**Future expansion available in:** [[products/01-power-bi-template/specifications/core/03-metrics-catalog|Metrics Catalog]] (~150 total metrics)
...
* **Documentation:**
 * [[products/01-power-bi-template/specifications/core/04-implementation-subset|Implementation Subset]] - Primary build guide
 * [[products/01-power-bi-template/specifications/technical/03-design-ux-specifications|Design & UX Specs]] - Visual layouts
 * [[products/01-power-bi-template/specifications/technical/01-power-bi-tech-spec|Power BI Tech Spec]] - DAX formulas
* **Data Files:**
...
Reference: [[products/01-power-bi-template/specifications/technical/02-database-schema|Database Schema]] Part 2
...
Reference: [[products/01-power-bi-template/specifications/technical/03-design-ux-specifications|Design & UX Specifications]]
...
3. **Expand (Optional):** Refer to [[products/01-power-bi-template/specifications/core/03-metrics-catalog|Metrics Catalog]] for 100+ additional metrics
...
|----------|---------|-------------|
| [[products/01-power-bi-template/specifications/core/04-implementation-subset|Implementation Subset]] | What to build (~25 metrics/tab) | **Primary build guide** |
| [[products/01-power-bi-template/specifications/technical/03-design-ux-specifications|Design & UX Specs]] | How to display | Visual design reference |
| [[products/01-power-bi-template/specifications/technical/01-power-bi-tech-spec|Power BI Tech Spec]] | SQL + DAX formulas | Technical implementation |
| [[products/01-power-bi-template/specifications/core/03-metrics-catalog|Metrics Catalog]] | Full catalog (~150 metrics) | Future expansion requests |
